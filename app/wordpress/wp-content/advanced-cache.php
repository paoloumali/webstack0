...
if ( ! @file_exists( '/var/www/html/wordpress/wp-content/plugins/breeze/breeze.php' ) ) { return; }
$config['config_path'] = '/var/www/html/wordpress/wp-content/breeze-config/breeze-config.php';
...
if ( @file_exists( '/var/www/html/wordpress/wp-content/plugins/breeze/inc/cache/execute-cache.php' ) ) {
	include_once '/var/www/html/wordpress/wp-content/plugins/breeze/inc/cache/execute-cache.php';
}
